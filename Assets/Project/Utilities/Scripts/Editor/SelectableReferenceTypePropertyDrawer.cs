...
{
    [CustomPropertyDrawer(typeof(SelectableReferenceTypeAttribute))]
    public class SelectableReferenceTypePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (possibleTypes == null)
                possibleTypes = GetDerivedTypes((SelectableReferenceTypeAttribute)attribute);
            ...
            if (popupTypeIndex >= 0 && popupTypeIndex < possibleTypes.Count)
            {
                ...
                {
                    property.managedReferenceValue = possibleTypes[popupTypeIndex] == null ? null : Activator.CreateInstance(possibleTypes[popupTypeIndex]);
        ...
        public static List<Type> GetDerivedTypes(SelectableReferenceTypeAttribute parent)
        {
